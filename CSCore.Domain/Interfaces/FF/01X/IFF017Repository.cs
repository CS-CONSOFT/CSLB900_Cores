...
namespace CSCore.Domain.Interfaces.FF._01X
{
    ...
    {
        Task<(List<CSICP_FF017>, int)> GetListAsync(int in_tenant, string in_estabId, string? in_nomeCliente,
        ...
        Task<bool> SumarizarOsTotais(List<CSICP_FF018> InFF018, int InTenantID);
    }
}
