...
namespace CSCore.Domain.Interfaces.FF._1XX
{
    ...
    {
        Task<(List<RepoDtoCSICP_FF102>, int)> GetListAsync(int tenant, int page, int pageSize,
        ...
        Task<RepoDtoCSICP_FF102?> GetByIdAsync(int tenant, string? id, int? in_tipoRegistro);
    }
}
