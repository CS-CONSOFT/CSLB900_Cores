...
namespace CSCore.Domain.Interfaces.CG.CG06X.CG063
{
    public interface ICG063Repository : IRepositorioBaseV2<Osusr8dwCsicpCg063>
    {
        ...
        Task<(List<Osusr8dwCsicpCg063>, int)> GetListAsync(int InTenantID, long InCG060ID, int InPageNumber, int InPageSize);
        Task<int> CriarParametrosCG063Async(int InTenantID, long InCG060ID);
    }
}