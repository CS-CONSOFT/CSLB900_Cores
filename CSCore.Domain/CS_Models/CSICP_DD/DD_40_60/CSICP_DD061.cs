...
public partial class CSICP_DD061
{
    ...
    [Column("UB16_VBC", TypeName = "decimal(37,yes)")]
    public decimal? UB16_VBC { get; set; }

    [Column("UB17_UFID", TypeName = "nvarchar(yes)")]
    public string? UB17_UFID { get; set; }

    [Column("UB36_MUNICIPIOID", TypeName = "nvarchar(yes)")]
    public string? UB36_MUNICIPIOID { get; set; }

    [Column("UB18_37_56_PIBSCBS", TypeName = "decimal(7,yes)")]
    public decimal? UB18_37_56_PIBSCBS { get; set; }

    [Column("UB22_41_60_PDIF", TypeName = "decimal(7,yes)")]
    public decimal? UB22_41_60_PDIF { get; set; }

    [Column("UB23_42_61_VDIF", TypeName = "decimal(37,yes)")]
    public decimal? UB23_42_61_VDIF { get; set; }

    [Column("UB25_44_63_VDEVTRIB", TypeName = "decimal(37,yes)")]
    public decimal? UB25_44_63_VDEVTRIB { get; set; }

    [Column("UB27_46_65_PREDALIQ", TypeName = "decimal(7,yes)")]
    public decimal? UB27_46_65_PREDALIQ { get; set; }

    [Column("UB28_47_66_PALIQEFET", TypeName = "decimal(7,yes)")]
    public decimal? UB28_47_66_PALIQEFET { get; set; }

    [Column("UB35_54_67_VIBSCBS", TypeName = "decimal(37,yes)")]
    public decimal? UB35_54_67_VIBSCBS { get; set; }

    [Column("UB77_82_VCREDPRESCONDSUS", TypeName = "decimal(37,yes)")]
    public decimal? UB77_82_VCREDPRESCONDSUS { get; set; }

    [Column("UB71_72A_72C_PIBSCBS", TypeName = "decimal(7,yes)")]
    public decimal? UB71_72A_72C_PIBSCBS { get; set; }

    [Column("UB72_72B_72D_VTRIBREGIBS", TypeName = "decimal(15,yes)")]
    public decimal? UB72_72B_72D_VTRIBREGIBS { get; set; }

    [Column("UB75_80_PCREDPRES", TypeName = "decimal(7,yes)")]
    public decimal? UB75_80_PCREDPRES { get; set; }

    [Column("UB76_81_VCREDPRES", TypeName = "decimal(37,yes)")]
    public decimal? UB76_81_VCREDPRES { get; set; }

    [Column("UB82B_82D_82F_PIBS", TypeName = "decimal(7,yes)")]
    public decimal? UB82B_82D_82F_PIBS { get; set; }

    [Column("UB82C_82E_82G_VIBS", TypeName = "decimal(15,yes)")]
    public decimal? UB82C_82E_82G_VIBS { get; set; }

    [Column("UB85_QBCMONO", TypeName = "decimal(15,yes)")]
    public decimal? UB85_QBCMONO { get; set; }

    [Column("UB86_ADREMIBS", TypeName = "decimal(7,yes)")]
    public decimal? UB86_ADREMIBS { get; set; }

    [Column("UB87_ADREMCBS", TypeName = "decimal(7,yes)")]
    public decimal? UB87_ADREMCBS { get; set; }

    [Column("UB88_VIBSMONO", TypeName = "decimal(15,yes)")]
    public decimal? UB88_VIBSMONO { get; set; }

    [Column("UB88_VCBSMONO", TypeName = "decimal(15,yes)")]
    public decimal? UB88_VCBSMONO { get; set; }

    [Column("UB91_QBCMONORET", TypeName = "decimal(15,yes)")]
    public decimal? UB91_QBCMONORET { get; set; }

    [Column("UB92_ADREMIBSRETEN", TypeName = "decimal(7,yes)")]
    public decimal? UB92_ADREMIBSRETEN { get; set; }

    [Column("UB93_VIBSMONORETEN", TypeName = "decimal(15,yes)")]
    public decimal? UB93_VIBSMONORETEN { get; set; }

    [Column("UB93A_ADREMCBSRETEN", TypeName = "decimal(7,yes)")]
    public decimal? UB93A_ADREMCBSRETEN { get; set; }

    [Column("UB93B_VCBSMONORETEN", TypeName = "decimal(15,yes)")]
    public decimal? UB93B_VCBSMONORETEN { get; set; }

    [Column("UB95_QBCMONORET", TypeName = "decimal(15,yes)")]
    public decimal? UB95_QBCMONORET { get; set; }

    [Column("UB96_ADREMIBSRET", TypeName = "decimal(7,yes)")]
    public decimal? UB96_ADREMIBSRET { get; set; }

    [Column("UB97_VIBSMONORET", TypeName = "decimal(15,yes)")]
    public decimal? UB97_VIBSMONORET { get; set; }

    [Column("UB98_ADREMCBSRET", TypeName = "decimal(7,yes)")]
    public decimal? UB98_ADREMCBSRET { get; set; }

    [Column("UB98A_VCBSMONORET", TypeName = "decimal(15,yes)")]
    public decimal? UB98A_VCBSMONORET { get; set; }

    [Column("UB100_PDIFIBS", TypeName = "decimal(7,yes)")]
    public decimal? UB100_PDIFIBS { get; set; }

    [Column("UB101_VIBSMONODIF", TypeName = "decimal(15,yes)")]
    public decimal? UB101_VIBSMONODIF { get; set; }

    [Column("UB102_PDIFCBS", TypeName = "decimal(7,yes)")]
    public decimal? UB102_PDIFCBS { get; set; }

    [Column("UB103_VCBSMONODIF", TypeName = "decimal(15,yes)")]
    public decimal? UB103_VCBSMONODIF { get; set; }

    [Column("UB104_VTOTIBSMONOITEM", TypeName = "decimal(15,yes)")]
    public decimal? UB104_VTOTIBSMONOITEM { get; set; }

    [Column("UB105_VTOTCBSMONOITEM", TypeName = "decimal(15,yes)")]
    public decimal? UB105_VTOTCBSMONOITEM { get; set; }

    [Column("UB05_VBCIS", TypeName = "decimal(15,yes)")]
    public decimal? UB05_VBCIS { get; set; }

    [Column("UB06_PIS", TypeName = "decimal(7,yes)")]
    public decimal? UB06_PIS { get; set; }

    [Column("UB06_PISESPEC", TypeName = "decimal(7,yes)")]
    public decimal? UB06_PISESPEC { get; set; }

    [Column("UB10_QTRIB", TypeName = "decimal(15,yes)")]
    public decimal? UB10_QTRIB { get; set; }

    [Column("UB11_VIS", TypeName = "decimal(15,yes)")]
    public decimal? UB11_VIS { get; set; }

    [Column("UB107_108_VIBS", TypeName = "decimal(15,yes)")]
    public decimal? UB107_108_VIBS { get; set; }

    [Column("UB110_TPCREDPRESIBSZFM", TypeName = "nvarchar(yes)")]
    public string? UB110_TPCREDPRESIBSZFM { get; set; }

    [Column("UB111_VCREDPRESIBSZFM", TypeName = "decimal(15,yes)")]
