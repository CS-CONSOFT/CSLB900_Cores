...
public partial class Osusr8dwCsicpCg072
{
    public int TenantId { get; set; }

    public long Cg072Id { get; set; }

    public long? Cg072Contlancinter { get; set; }

    public long? Cg072Conteventovalortp { get; set; }

    public decimal? Cg072Valor { get; set; }
