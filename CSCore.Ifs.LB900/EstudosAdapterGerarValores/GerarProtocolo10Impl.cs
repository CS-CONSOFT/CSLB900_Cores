...
namespace CSCore.Ifs.LB900.AdapterGerarValores
{
    public class GerarProtocolo10Impl : IGenerate
    {
        ...
        public async Task<string> Generate(string empresaID, string arquivo, string textName)
        {
            decimal protocolo = await generateProtocolo.Fcn_Protocolo10(empresaID, arquivo);
