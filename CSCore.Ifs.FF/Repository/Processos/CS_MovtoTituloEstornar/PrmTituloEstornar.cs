...
{
    public class PrmTituloEstornar : PrmTituloEstornarController
    {
    ...
    public class PrmTituloEstornarController
    {
        ...
        public string InBB001FilialID { get; set; }
        public string InMotivoEstorno { get; set; } = string.Empty;
    }
}
