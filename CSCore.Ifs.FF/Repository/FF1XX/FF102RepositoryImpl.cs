...
namespace CSCore.Ifs.FF.Repository.FF1XX
{
        ...
        : RepositorioBaseImpl<CSICP_FF102>(appDbContext, "Id"), IFF102Repository
    {
        ...
        public async Task<RepoDtoCSICP_FF102?> GetByIdAsync(int in_tenant, string in_ff102Id, int? in_tipoRegistro)
        {
            ...
            {
                query = query.Where(e => e.CSICP_FF102.Ff102Tiporegistro == in_tipoRegistro);
            }

            RepoDtoCSICP_FF102? retRepoDtoFF102 = await query.FirstOrDefaultAsync(e => e.CSICP_FF102.Id == in_ff102Id);
        ...
        private async Task CalcularValoresAtrasoReceberAsync(RepoDtoCSICP_FF102 retRepoDtoFF102)
        {
            ...
            {
                InTenantID = retRepoDtoFF102.CSICP_FF102.TenantId,
                InDataVencimento = retRepoDtoFF102.CSICP_FF102.Ff102DataVencimento,
                InDiasLiberacao = retRepoDtoFF102.CSICP_FF102.Ff102Nodiasliberacao,
                InValorTitulo = retRepoDtoFF102.CSICP_FF102.Ff102VlLiqTitulo,
                InPercentualCorrecaoMonetaria = retRepoDtoFF102.CSICP_FF102.Ff102PercCorrmonetaria,
                InPercentualMulta = retRepoDtoFF102.CSICP_FF102.Ff102PercMulta,
                InPercentualJuros = retRepoDtoFF102.CSICP_FF102.Ff102PercJurosAtr,
                InPercentualHonorarios = retRepoDtoFF102.CSICP_FF102.Ff102PercHonorarios,
                InEstabID = retRepoDtoFF102.CSICP_FF102.Ff102Filialid ?? "",
            ...
            retRepoDtoFF102.CSValorAPagar = prmRetornoCalculo.OutValorJuros +
                                            ...
                                            retRepoDtoFF102.CSICP_FF102.Ff102VlLiqTitulo;
        }
            ...
            QualDataFiltro? in_tipoDataFiltro)
        {
            ...
            if (in_estabelecimentoId != null)
                query = query.Where(e => e.CSICP_FF102.Ff102Filialid!.Equals(in_estabelecimentoId));

            if (in_tipoRegistro != null)
                query = query.Where(e => e.CSICP_FF102.Ff102Tiporegistro!.Equals(in_tipoRegistro));

            if (in_prefixo != null)
                query = query.Where(e => e.CSICP_FF102.Ff102Pfx!.Equals(in_prefixo));

            if (in_titulo != null)
                query = query.Where(e => e.CSICP_FF102.Ff102NoTitulo!.Equals(in_titulo));

            if (in_sufixo != null)
                query = query.Where(e => e.CSICP_FF102.Ff102Sfx!.Equals(in_sufixo));

            if (in_nomeConta != null)
                query = query.Where(e => e.NavBB012ContaID!.Bb012NomeCliente!.Contains(in_nomeConta));

            if (in_situacaoId != null)
                query = query.Where(e => e.CSICP_FF102.Ff102Situacaoid!.Equals(in_situacaoId));

            if (in_codigoConta != null)
                query = query.Where(e => e.NavBB012ContaID!.Bb012Codigo.Equals(in_codigoConta));

            if (in_TpCobranca != null)
                query = query.Where(e => e.CSICP_FF102.Ff102Tpcobranca!.Equals(in_TpCobranca));

            if (in_NoTitulonoBanco != null)
                query = query.Where(e => e.CSICP_FF102.Ff102NoTitulonobanco!.Equals(in_NoTitulonoBanco));

            if (in_serie != null)
                query = query.Where(e => e.CSICP_FF102.Ff102SerieNf!.Equals(in_serie));

            if (in_numeroNotaf != null)
                query = query.Where(e => e.CSICP_FF102.Ff102NumeroNf!.Equals(in_numeroNotaf));
            ...
            if (in_tipoDataFiltro == QualDataFiltro.Emissao && in_dataInicio.HasValue && in_dataFinal.HasValue)
                query = query.Where(e => e.CSICP_FF102.Ff102DataEmissao >= in_dataInicio && e.CSICP_FF102.Ff102DataEmissao <= in_dataFinal);

            if (in_tipoDataFiltro == QualDataFiltro.Vencimento && in_dataInicio.HasValue && in_dataFinal.HasValue)
                query = query.Where(e => e.CSICP_FF102.Ff102DataVencimento >= in_dataInicio && e.CSICP_FF102.Ff102DataVencimento <= in_dataFinal);

            if (in_tipoDataFiltro == QualDataFiltro.UltimaBaixa && in_dataInicio.HasValue && in_dataFinal.HasValue)
                query = query.Where(e => e.CSICP_FF102.Ff102DataUltPagto >= in_dataInicio && e.CSICP_FF102.Ff102DataUltPagto <= in_dataFinal);
