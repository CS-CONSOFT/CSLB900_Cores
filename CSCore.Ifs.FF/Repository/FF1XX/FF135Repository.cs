...
namespace CSCore.Ifs.FF.Repository.FF1XX
{
    public interface IFF135Repository
    {
        ...
        Task<(List<CSICP_FF135>, int)> GetListCartaDeDebito(
             int tenant, DateTime DataInicial, DateTime DataFinal,
             string? BB012_ContaID,
             string? BB012_NomeConta,
             int? status,
             int page,
             int pageSize);
    }
    public class FF135Repository : IFF135Repository
    {
        ...
        public async Task<CSICP_FF135> GetById(int tenant, string id)
        {
            var WorkFF135 = await this.appDbContext.OsusrE9aCsicpFf135s
                ...
                .Where(e => e.Ff135CartadebitoId == id)
                 .Include(e => e.NavCSICP_BB012)
            .Include(e => e.NavCSICP_BB001)
            .Include(e => e.NavFf135Status)
        ...
        public async Task<(List<CSICP_FF135>, int)> GetListCartaDeDebito(
            int tenant, DateTime DataInicial, DateTime DataFinal,
            string? BB012_ContaID,
            string? BB012_NomeConta,
            int? status,
            ...
            int pageSize)
        {
            ...
            if (BB012_ContaID != null && BB012_ContaID != "") query = query.Where(e => e.Ff135ContafornecId == BB012_ContaID);
            if (status != null && status > 0) query = query.Where(e => e.Ff135Statusid == status);
            if (BB012_NomeConta != null && BB012_NomeConta != "")
            {
                query = query.Where(e => e.NavCSICP_BB012 != null && e.NavCSICP_BB012.Bb012NomeCliente != null &&
                            (e.NavCSICP_BB012.Bb012NomeCliente.StartsWith(BB012_NomeConta) ||
                             e.NavCSICP_BB012.Bb012NomeCliente.Contains(BB012_NomeConta)));
            }
