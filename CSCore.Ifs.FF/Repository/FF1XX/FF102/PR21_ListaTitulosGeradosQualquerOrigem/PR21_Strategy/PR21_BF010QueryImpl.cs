...
{
    public class PR21_BF010QueryImpl : PR21_IQueryImpl
    {
        private string IDControle;
        public PR21_BF010QueryImpl(AppDbContext appDbContext, string InIDControle) : base(appDbContext)
        {
        ...
        {
            query = query.Where(e => e.NavFF104 != null && e.NavFF104.Bf010Id == long.Parse(this.IDControle))
