...
{
    internal class PR21_DD190QueryImpl : PR21_IQueryImpl
    {
        private string IDControle;
        public PR21_DD190QueryImpl(AppDbContext appDbContext, string InIDControle) : base(appDbContext)
        {
        ...
        {
            query = query.Where(e => e.NavFF104 != null && e.NavFF104.Dd190Id == long.Parse(this.IDControle));
            return query;
        }
