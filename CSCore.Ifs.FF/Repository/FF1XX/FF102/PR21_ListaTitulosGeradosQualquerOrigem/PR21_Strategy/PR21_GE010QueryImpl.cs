...
{
    internal class PR21_GE010QueryImpl : PR21_IQueryImpl
    {
        private string IDControle;
        public PR21_GE010QueryImpl(AppDbContext appDbContext, string InIDControle) : base(appDbContext)
        {
        ...
        {
            query = query.Where(e => e.NavFF104 != null && e.NavFF104.Ge010Id == this.IDControle);
            return query;
        }
