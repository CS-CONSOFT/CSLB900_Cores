...
{
    public class PR21_FF040QueryImpl : PR21_IQueryImpl
    {
        private string IDControle;
        public PR21_FF040QueryImpl(AppDbContext appDbContext, string InIDControle) : base(appDbContext)
        {
        ...
        {
            query = query.Where(e => e.NavFF104 != null && e.NavFF104.Ff040Id == long.Parse(this.IDControle))
