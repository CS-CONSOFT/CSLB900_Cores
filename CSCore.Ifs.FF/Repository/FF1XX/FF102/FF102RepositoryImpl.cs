...
namespace CSCore.Ifs.FF.Repository.FF1XX.FF102
{
        ...
        : RepositorioBaseImpl<CSICP_FF102>(appDbContext, "Id"), IFF102Repository
    {
        ...
        public async Task<CSICP_FF102?> GetByIdAsyncSimples(int in_tenant, string in_ff102Id, int? in_tipoRegistro)
        {
        ...
        private IQueryable<CSICP_FF102> GetQueryBaseSimples(int in_tenant)
        {
