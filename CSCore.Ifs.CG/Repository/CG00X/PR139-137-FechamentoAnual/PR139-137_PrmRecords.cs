...
namespace CSCore.Ifs.CG.Repository.CG00X.PR139_137_FechamentoAnual
{
 ...
 decimal Saldo
    ...
    ) : PR139137_PrmCS_GetListaContasInput(InAnoFechamento, InTipoSaldoID, InFilialID);
        ...
        string InCG008_ID_TipoSaldo, ICS_GenerateId CS_GenerateId)
    {
        ...
        /// </summary>
        public List<int> InMeses { get; set; } = [];

        /// <summary>
        /// Retorna a lista de meses a serem considerados no cálculo
        /// </summary>
        public List<int> GetMesesParaCalculo() => InMeses ?? [0];

        /// <summary>
        /// Retorna o maior mês do período
        /// </summary>
        public int GetMesFinal() => InMeses.Max();
        public int GetMesInicial() => InMeses.Min();
