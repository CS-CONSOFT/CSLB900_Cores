...
namespace CSCore.Ifs.Rebanho.RR007Repository_Proprietario
{
    public class RR007RepositoryImpl : RepositorioBaseImplV2<OsusrTo3CsicpRr007>, IRR007Repository
    {
        ...
        {
            IQueryable<OsusrTo3CsicpRr007> query = GetQueryBase(In_TenantID);
        ...
        private IQueryable<OsusrTo3CsicpRr007> GetQueryBase(int In_TenantID)
        {
            return _appDbContext.OsusrTo3CsicpRr007s
                .AsNoTracking()
                .AsSplitQuery()
