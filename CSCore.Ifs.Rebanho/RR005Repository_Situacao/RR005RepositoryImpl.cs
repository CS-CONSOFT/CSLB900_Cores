...
namespace CSCore.Ifs.Rebanho.RR005Repository_Situacao
{
    public class RR005RepositoryImpl : RepositorioBaseImplV2<OsusrTo3CsicpRr005>, IRR005Repository
    {
        ...
        {
            IQueryable<OsusrTo3CsicpRr005> query = GetQueryBase(In_TenantID);
        ...
        private IQueryable<OsusrTo3CsicpRr005> GetQueryBase(int In_TenantID)
        {
            return _appDbContext.OsusrTo3CsicpRr005s
                .AsNoTracking()
                .AsSplitQuery()
