...
namespace CSCore.Ifs.Rebanho.RR008Repository_RegimeAlimentar
{
    public class RR008RepositoryImpl : RepositorioBaseImplV2<OsusrTo3CsicpRr008>, IRR008Repository
    {
        ...
        {
            IQueryable<OsusrTo3CsicpRr008> query = GetQueryBase(In_TenantID);
        ...
        private IQueryable<OsusrTo3CsicpRr008> GetQueryBase(int In_TenantID)
        {
            return _appDbContext.OsusrTo3CsicpRr008s
                .AsNoTracking()
                .AsSplitQuery()
