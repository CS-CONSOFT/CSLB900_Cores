...
namespace CSCore.Ifs.Rebanho.RR006Repository_Ocorrencia
{
    public class RR006RepositoryImpl : RepositorioBaseImplV2<OsusrTo3CsicpRr006>, IRR006Repository
    {
        ...
        {
            IQueryable<OsusrTo3CsicpRr006> query = GetQueryBase(In_TenantID);
        ...
        private IQueryable<OsusrTo3CsicpRr006> GetQueryBase(int In_TenantID)
        {
            return _appDbContext.OsusrTo3CsicpRr006s
                .AsNoTracking()
                .AsSplitQuery()
