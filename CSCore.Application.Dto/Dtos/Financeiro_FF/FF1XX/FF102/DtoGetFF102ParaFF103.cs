...
namespace CSCore.Application.Dto.Dtos.Financeiro_FF.FF1XX.FF102
{
    ...
    /// - NavBB012ContaID: Dados detalhados da conta BB012, como código, nome do cliente, limites e informações relacionadas.
    /// - NavFF102Sit: Situação do registro FF102, incluindo identificador, label, ordem e status.
    /// </summary>
    public class DtoGetFF102ParaFF103
    {
