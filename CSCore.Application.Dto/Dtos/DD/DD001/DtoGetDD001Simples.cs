...
{
    public record DtoGetDD001Simples : IConverteParaDTO<CSICP_DD001, DtoGetDD001Simples>
    {
        ...
        public static DtoGetDD001Simples FromEntity(CSICP_DD001 entity)
        {
            return new DtoGetDD001Simples
            {
