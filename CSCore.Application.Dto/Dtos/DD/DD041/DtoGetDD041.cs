...
using CSCore.Application.Dto.Dtos.DD.DD040;
using CSCore.Domain;
...
namespace CSCore.Application.Dto.Dtos.DD.DD041
{
    public class DtoGetDD041
    {
        ...
        public DtoGetAA028_Simples? NavAA028 { get; set; }
