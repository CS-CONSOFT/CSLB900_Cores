...
//            BB008_Tipo_ID: 1,
//            Prm_Total_Fatura: 100m, // Valor que gera resto na divis�o
//            Prm_Valor_Entrada: 0m,
...
//        // Verifica se a soma das parcelas � igual ao total
...
//    #region Teste Pagamento por Per�odo (Meses)
...
//            BB008_Tipo_ID: 3, // Tipo PARCELA M�S
...
//        var memoriaItem = new MemoriaCalculoItem(
//            InNumeroParcelas: null, // For�a uso do CS_Get_Qtd_Parcelas
...
//        var memoriaItem = new MemoriaCalculoItem(
//            InNumeroParcelas: 0, // For�a uso do CS_Get_Qtd_Parcelas
//            CondicaoPagamento: "5;0;1", // Para tipo m�s: retorna int.Parse([0]) = 5
//            BB008_Tipo_ID: 3, // Tipo M�S
//            Prm_Total_Fatura: 1000m,
//            Prm_Valor_Entrada: 0m,
...
//        // Assert
//        Assert.Equal(5, resultado.Count); // CS_Get_Qtd_Parcelas retorna 5 para tipo m�s
//    }

//    #endregion

//    #region Testes de Valida��o
...
//        var memoriaItem = new MemoriaCalculoItem(
//            InNumeroParcelas: -1, // Valor inv�lido
...
//        Assert.Equal("N�mero de parcelas deve ser maior que zero.", exception.Message);
//    }
...
//        Assert.Equal(0m, resultado[0].Valor_Parcela); // Deve ser 0 quando valores s�o nulos
//    }
...
//        var memoriaItem = new MemoriaCalculoItem(
//            InNumeroParcelas: 5,
//            CondicaoPagamento: "0;7;14;21;30", // 5 parcelas em dias espec�ficos
//            BB008_Tipo_ID: 1,
...
//        // Verifica se todas as datas est�o corretas
...
//        // Verifica se a soma total est� correta
//        var somaTotal = resultado.Sum(r => r.Valor_Parcela);
...
//    {
//        // Arrange - Simulando um cen�rio real de 12 parcelas mensais
//        var parameters = new CS_Get_Qtd_ParcelasParameters(
//            InStID_BB008_TP_DIAS: 1,
//            InStID_BB008_ParcelaDias: 2,
//            InStID_BB008_ParcelaMes: 3,
...
//        var memoriaItem = new MemoriaCalculoItem(
//            InNumeroParcelas: 12,
//            CondicaoPagamento: "12;0;1", // 12 parcelas, sem entrada, intervalo 1 m�s
//            BB008_Tipo_ID: 3, // Tipo M�S
...
//        // Verifica se todas as parcelas t�m o mesmo valor
